    ...
    <section className=" max-w-[1120px] w-full mt-[240px] flex gap-[24px] flex-col ss:flex-row">
      <div className="relative">
        <div className="absolute top-[32px] md:top-[48px] left-[32px] md:left-[48px]">
          ...
          <button className="font-medium text-[16px] leading-[28px] tracking-tighter-[-0.4px]  text-[#141718] border-b-[1px] border-[#141718] flex items-center" onClick={handlePush}>
            Shop Now
            <Image
              src={ArrowRight}
              width={20}
